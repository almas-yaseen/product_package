...
// Slideshow
const slideshowDivs = () => {
    const staticPath = "/static"; // Adjust this based on your static files configuration

    for (let i = 1; i <= 5; i++) {
        const div = document.createElement('div');

        div.style.backgroundImage = `url(${staticPath}/images/slideshow/section-1-bg-${i}.jpg)`;
